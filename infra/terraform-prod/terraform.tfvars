...
server_name = "k3s-server-lihag-prod"          # Name for the k3s server (default)
base_name = "assignment3-lihag-prod"                   # Prefix for network resources (default)

# Unik subnet för prod-miljön (byt om det krockar med staging)
