          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div>
              ...
              {ongoingReports.length > 0 ? (
                ongoingReports.map((r) => <ReportCard key={r.id} report={r} />)
              ) : (
            ...
            <div>
              ...
              {resolvedReports.length > 0 ? (
                resolvedReports.map((r) => <ReportCard key={r.id} report={r} />)
              ) : (
